...
export const LEVEL_DESCRIPTIONS: Record<number, string> = {
  ...
  2: '<strong>B – Fun</strong><br/>• Sustenta trocas de bola mais lentas<br/>• Já saca e devolve com regularidade<br/>• Consegue manter ritmo em bate‑bola recreativo<br/><br/><em>Fortalecer:</em> melhorar precisão (acertar “ponto doce” da raquete) e memorizar posições de ataque/defesa.',
